...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon { font-size: 80px; color: #00a0e9; margin-bottom: 20px; }
        h1 { font-size: 28px; font-weight: 800; color: #333; margin-bottom: 12px; }
        p { color: #6c757d; font-size: 15px; margin-bottom: 8px; }
        .amount { font-size: 32px; font-weight: 800; color: #00a0e9; margin: 30px 0; }
        .btn { display: inline-block; padding: 12px 40px; margin-top: 20px; border-radius: 10px; background: linear-gradient(135deg, #0066b2 0%, #00a0e9 100%); color: white; text-decoration: none; font-weight: 700; transition: all 0.3s ease; }
        .btn:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(0, 160, 233, 0.4); }
    </style>
</head>
<body>
<div class="container">
